...
@NamedQueries({
    ...
    @NamedQuery(name = "Login_1.findBySecurityQuestion", query = "SELECT l FROM Login_1 l WHERE l.securityQuestion = :securityQuestion"),
    @NamedQuery(name = "Login_1.findByAnswer", query = "SELECT l FROM Login_1 l WHERE l.answer = :answer")})
public class Login_1 implements Serializable {
    ...
    public String toString() {
        return "Login.Login_1[ username=" + username + " ]";
    }
